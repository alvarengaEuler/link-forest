...
export default function Dashboard() {
  ...
  const [selectedTheme, setSelectedTheme] = useState<Theme>(themes.find((t) => t.id === "default") || themes[0])
  ...
  const addAnnouncement = () => {
    ...
    setData({
      ...data,
      announcements: [...data.announcements, { id: newId, title: "Novo Aviso", content: "Conteúdo do aviso" }],
    })
  }
  ...
  return (
    <div className="flex h-screen overflow-hidden">
        ...
        <div className="h-full overflow-y-auto p-6">
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            ...
            <TabsContent value="links">
              <LinksEditor links={data.links} theme={selectedTheme} onLinksChange={handleLinksChange} />
            </TabsContent>
            ...
            <TabsContent value="tips">
              <TipsEditor tips={data.tips} onTipChange={handleTipChange} onAddTip={addTip} onRemoveTip={removeTip} />
            </TabsContent>
          </Tabs>
        </div>
      </div>
      ...
      {/* Preview Panel - Fixo */}
      <div className={`flex-1 transition-all duration-300 ease-in-out ${showEditor ? "hidden md:block" : "block"}`}>
