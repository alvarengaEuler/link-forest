...
const initialServices: Service[] = [
  {
    ...
    description:
      'Exame completo da cavidade abdominal para diagnóstico de alterações em órgãos internos.',
...
O exame é realizado com o animal acordado, em posição confortável, e tem duração média de 20 a 30 minutos.`,
  ...
  },
  {
    ...
    description:
      'Acompanhamento da gestação, contagem fetal e avaliação do desenvolvimento dos filhotes.',
...
Recomendamos realizar o primeiro exame entre 20-25 dias após o cruzamento e acompanhamentos periódicos durante a gestação.`,
  ...
  },
  {
    ...
    description:
      'Exame por imagem que avalia estruturas internas dos olhos, ideal para detectar alterações oftálmicas.',
  ...
  É um exame rápido, indolor e não invasivo, realizado com o animal acordado e levemente contido.`,
    preparo:
      'Não é necessário jejum. O animal deve estar calmo; em alguns casos, pode ser necessário o uso de colírio anestésico.',
    duracao: '15 a 20 minutos',
    recomendado: [
...
export function useServices() {
  ...
  const updateService = (id: string, updatedService: NewService) => {
    ...
    setServices(prev =>
      prev.map(service => (service.id === id ? ({ ...updatedService, id } as Service) : service)),
    );
    toast({
