...
export function ServiceForm({ initialData, onSubmit, onCancel, isSubmitting = false }: ServiceFormProps) {
  const [recommendations, setRecommendations] = useState<string[]>(initialData?.recomendado || [""])
          ...
          <CardContent className="space-y-6">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Ex: ultrassom-abdominal" {...field} value={field.value || ""} />
                    </FormControl>
                    <FormDescription>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea placeholder="Breve descrição do serviço (exibida nos cards)" rows={2} {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Use quebras de linha para formatar o texto. Você pode usar marcadores como • para listas.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea placeholder="Instruções de preparo para o exame" rows={3} {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
            ...
            <div>
              ...
              {form.formState.errors.recomendado && (
                <p className="text-sm font-medium text-destructive mt-2">{form.formState.errors.recomendado.message}</p>
              )}
            </div>
          </CardContent>
